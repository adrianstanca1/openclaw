...
const RECOMMENDED_MODELS: ModelConfig[] = [
  { name: 'llama3.2:3b', purpose: 'Fast responses', vram: '2GB', context: 8192, use_case: 'Chat, quick tasks', performance_score: 95 },
  { name: 'llama3.1:8b', purpose: 'Balanced performance', vram: '6GB', context: 8192, use_case: 'General, coding', performance_score: 90 },
  { name: 'mistral:7b', purpose: 'Efficient inference', vram: '5GB', context: 8192, use_case: 'Long context', performance_score: 88 },
  { name: 'codellama:7b', purpose: 'Code generation', vram: '5GB', context: 16384, use_case: 'Programming', performance_score: 92 },
  { name: 'phi3:mini', purpose: 'Ultra-fast', vram: '2GB', context: 4096, use_case: 'Quick Q&A', performance_score: 85 },
]
...
async function detectHardware() {
  ...
  if (ramGB < 8) profile = 'minimal'
  else if (ramGB < 16) profile = 'standard'
  else if (ramGB < 32) profile = 'enthusiast'
