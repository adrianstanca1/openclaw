...
export const OLLAMA_DEFAULT_MODEL_ID = "gemma3";
export const OLLAMA_DEFAULT_MODEL_REF = "ollama/gemma3";
export const LITELLM_DEFAULT_MODEL_REF = "litellm/claude-opus-4-6";
export const VERCEL_AI_GATEWAY_DEFAULT_MODEL_REF = "vercel-ai-gateway/anthropic/claude-opus-4.6";

export async function setOllamaConfig(baseUrl: string, agentDir?: string) {
  upsertAuthProfile({
